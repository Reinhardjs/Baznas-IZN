...
public class FragmentModul1Likert1 extends Fragment implements BlockingStep {
...
//            KajianDampakZakatPojo data = SurveyKDZActivity.data;
        ...
        int selection1 = listlik1.indexOf(Prefs.getString(StaticStrings.M1_lik1, ""));
        if (selection1 != -1)
            edt_lik1.setSelection(selection1);

        List<String> listLik2 = plants1;
        int selection2 = listLik2.indexOf(Prefs.getString(StaticStrings.M1_lik2, ""));
        if (selection2 != -1)
            edt_lik2.setSelection(selection2);

        List<String> listLik3 = plants2;
        int selection3 = listLik3.indexOf(Prefs.getString(StaticStrings.M1_lik3, ""));
        if (selection3 != -1)
            edt_lik3.setSelection(selection3);

        List<String> listLik4 = plants3;
        int selection4 = listLik4.indexOf(Prefs.getString(StaticStrings.M1_lik4, ""));
        if (selection4 != -1)
            edt_lik4.setSelection(selection4);

        List<String> listLik5 = plants4;
        int selection5 = listLik5.indexOf(Prefs.getString(StaticStrings.M1_lik5, ""));
        if (selection5 != -1)
